...
```python
np.add.at(a, [1, 1, 1], [10, 20, 30])  # a[1] becomes 90 (30 + 10 + 20 + 30)
```
...
* <span style="font-size: 14px;">**Out of bounds**: For an axis of length n, valid integer indices run from -n through n - 1.</span>